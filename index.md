...
.header-overlay {
    ...
    align-items: center;
    text-align: center;
    background: rgba(58, 42, 34, 0.6); /* tom marrom suave */
    color: white;
    padding: 1em;
}
...
<!-- Cards - LINKS CORRIGIDOS com /amor-psicanalise/ -->
...
<div class="recent-posts">
    ...
    <div style="text-align: center; margin-top: 2em;">
        <a href="/amor-psicanalise/artigos/" style="background: #d4a5a5; color: white; padding: 0.8em 2em; text-decoration: none; border-radius: 4px;">Ver todos os artigos</a>
    </div>
</div>
